            ...
            <Container>
                ...
                <Row>
                    <Col sm="12" style={{ textAlign: "left" }}>
                        {getBranchOfLibrary() === 1 || getBranchOfLibrary() === "" ?
                        <div>
                            <p>Читалищна библиотека към читалище "Искра 1964", гр. София</p>
                            <p>Лице за контакт: Иван Иванов</p>
                            <p>Длъжност: Зам.-директор по библиотечната дейност</p>
                            <p>Адрес: София, жк. Западен Парк, ул. Суходолска, бл. 60, 1373 София</p>
                            <p>Телефон: 02 821 5892</p>
                        </div>
                        :
                        <div>
                            <p>Читалищна библиотека към читалище "Иван Вазов", гр. Пловдив</p>
                            <p>Лице за контакт: Адриана Павлова </p>
                            <p>Длъжност: Главен библиотекар</p>
                            <p>Адрес: Пловдив, кв. Коматево, ул.Коматевско шосе 139</p>
                            <p>Телефон:  032 691 758</p>
                        </div>
                        }
                    </Col>
                </Row>
